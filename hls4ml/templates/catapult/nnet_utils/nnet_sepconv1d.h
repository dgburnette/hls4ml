...
template <class data_T, class res_T, typename CONFIG_T>
void depthwise_conv_1d_cl(data_T data[CONFIG_T::in_width * CONFIG_T::n_chan], ac_sync &sync_data,
                          res_T res[CONFIG_T::out_width * CONFIG_T::n_filt],  ac_sync &sync_res,
                          const typename CONFIG_T::weight_t weights[CONFIG_T::filt_width * CONFIG_T::n_chan],
                          const typename CONFIG_T::bias_t biases[CONFIG_T::n_chan]) {
  sync_data.sync_in();
  depthwise_conv_1d_cl<data_T, res_T, CONFIG_T>(data, res, weights, biases);
  sync_res.sync_out();
}
...
template <class data_T, class dw_res_T, class res_T, typename CONFIG_T>
void separable_conv_1d_cl(
    data_T data[CONFIG_T::depthwise_config::in_width * CONFIG_T::depthwise_config::n_chan], ac_sync &sync_data,
    res_T res[CONFIG_T::pointwise_config::out_width * CONFIG_T::pointwise_config::n_filt], ac_sync &sync_res,
    const typename CONFIG_T::depthwise_config::weight_t
        depthwise_weights[CONFIG_T::depthwise_config::filt_width * CONFIG_T::depthwise_config::n_chan],
    const typename CONFIG_T::pointwise_config::weight_t
        pointwise_weights[CONFIG_T::pointwise_config::n_chan * CONFIG_T::pointwise_config::n_filt],
...
{
  sync_data.sync_in();
  separable_conv_1d_cl<data_T, dw_res_T, res_T, CONFIG_T>(data, res, depthwise_weights,
                                                          pointwise_weights, depthwise_biases, pointwise_biases);
  sync_res.sync_out();
}
