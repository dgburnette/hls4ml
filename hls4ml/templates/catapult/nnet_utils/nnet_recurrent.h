...
template <class data_T, class res_T, typename CONFIG_T>
void lstm_stack(data_T data[CONFIG_T::n_sequence * CONFIG_T::n_in], ac_sync &sync_data,
                res_T res[CONFIG_T::n_sequence_out * CONFIG_T::n_state], ac_sync &sync_res,
                typename CONFIG_T::weight_t param[CONFIG_T::n_state * 4 * CONFIG_T::n_in],
                typename CONFIG_T::weight_t param_r[CONFIG_T::n_state * 4 * CONFIG_T::n_state],
                typename CONFIG_T::bias_t param_b[CONFIG_T::n_state * 4],
                typename CONFIG_T::bias_t param_br[CONFIG_T::n_state * 4])
{
  sync_data.sync_in();
  lstm_stack<data_T, res_T, CONFIG_T>(data, res, param, param_r, param_b, param_br);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void gru_stack(data_T data[CONFIG_T::n_sequence * CONFIG_T::n_in], ac_sync &sync_data,
               res_T res[CONFIG_T::n_sequence_out * CONFIG_T::n_state], ac_sync &sync_res,
               typename CONFIG_T::weight_t param[CONFIG_T::n_state * 3 * CONFIG_T::n_in],
...
{
  sync_data.sync_in();
  gru_stack<data_T, res_T, CONFIG_T>(data, res, param, param_zr, param_b, param_br);
  sync_res.sync_out();
}
...
{
  sync_data.sync_in();
  bidirectional_stack<data_T, res_T, CONFIG_T>(data, res, param, param_r, param_b, param_br, param_back, param_r_back, param_b_back, param_br_back);
  sync_res.sync_out();
}
