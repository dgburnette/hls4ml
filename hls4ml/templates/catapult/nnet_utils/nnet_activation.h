...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T> 
void linear(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
            res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  linear<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T> 
void relu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
          res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  relu<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, int MAX_INT, typename CONFIG_T>
void relu_max(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
              res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  relu_max<data_T, res_T, MAX_INT, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T> 
void relu6(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
           res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  relu6<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T> 
void relu1(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
           res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  relu1<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void sigmoid(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
             res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  sigmoid<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void tanh(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
          res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  tanh<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void hard_sigmoid(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
                  res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  hard_sigmoid<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
//#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void hard_tanh(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
               res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  hard_tanh<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class param_T, class res_T, typename CONFIG_T>
void leaky_relu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
                param_T alpha,
                res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  leaky_relu<data_T, param_T, res_T, CONFIG_T>(data, alpha, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class param_T, class res_T, typename CONFIG_T>
void thresholded_relu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
                      param_T theta,
                      res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  thresholded_relu<data_T, param_T, res_T, CONFIG_T>(data, theta, res);
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void softplus(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
              res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  softplus<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void softsign(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
              res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  softsign<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class param_T, class res_T, typename CONFIG_T>
void elu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
         const param_T alpha,
         res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  elu<data_T, param_T, res_T, CONFIG_T>(data, alpha, res);
  sync_res.sync_out();  
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T> 
void selu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
          res_T res[CONFIG_T::n_in], ac_sync &sync_res)
{
  sync_data.sync_in();
  selu<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class param_T, class res_T, typename CONFIG_T>
void prelu(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
           param_T alpha[CONFIG_T::n_in],
           res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  prelu<data_T, param_T, res_T, CONFIG_T>(data, alpha, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void binary_tanh(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
                 res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  binary_tanh<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
...
#pragma hls_design block
template <class data_T, class res_T, typename CONFIG_T>
void ternary_tanh(data_T data[CONFIG_T::n_in], ac_sync &sync_data,
                  res_T res[CONFIG_T::n_in], ac_sync &sync_res) 
{
  sync_data.sync_in();
  ternary_tanh<data_T, res_T, CONFIG_T>(data, res);
  sync_res.sync_out();
}
